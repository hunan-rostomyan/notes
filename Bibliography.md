...
- dependency parsing; parsing; nlp; ml; computer science; linguistics

Kulkarni, S., Harman, G. (2011) *An Elementary Introduction to Statistical Learning Theory*.
- statistical learning theory; machine learning

Le Guin, U.K. (2015) *Steering the Craft*.
- writing
...
Gashkov, S.B. (2012) *Entertaining Computer Arithmetic*
- numerical computing; mathematics; programming

Gindikin, S.G. (2001) *Stories about Physicists and Mathematicians*.
- physics; mathematics; biography; history of mathematics; history of science
